...
def my_load_data(path):
    spacyload_op = ops.LoadSpacy()

    with open(path, "r", encoding="utf-8") as f:
        data = [json.loads(line) for line in f]

    data = apply_transformation(data, spacyload_op)
    return data
...
def main(args):
    ...
    #data_positive = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st1_PLOS_formatted-positive.jsonl")
    ...
    #data_positive = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st2_PLOS_formatted-positive.jsonl")
    data_negative = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st2_PLOS_formatted-negative.jsonl")
