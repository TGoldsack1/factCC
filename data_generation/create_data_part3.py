...
def main(args):
    ...
    data_btrans = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st1_eLife_formatted-btrans.jsonl")
    ...
    #data_positive = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st1_eLife_formatted-positive.jsonl")
    data_pronoun = my_load_data("/home/acp20tg/factCC/data_generation/raw_data/st1_eLife_formatted-pronoun.jsonl")
